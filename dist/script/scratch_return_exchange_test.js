...
import { User, Product, ProductVariant, Order, OrderItem, Wallet, } from "../model/relations.js";
import { createReturnExchangeRequest, updateRequestStatus, } from "../services/order/returnExchange.service.js";
import { getOrCreateWallet } from "../services/wallet/wallet.service.js";
...
async function runTest() {
    ...
    // The order is created right now, so it is naturally within the 1-hour window.
