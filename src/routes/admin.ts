...
adminRouter.post("/orders/:id/tracking", AdminController.updateOrderTrackingDetails);
adminRouter.patch("/orders/:id/tracking", AdminController.updateOrderTrackingDetails);
adminRouter.put("/orders/:id/tracking", AdminController.updateOrderTrackingDetails);
adminRouter.post("/orders/:id/booking-details", AdminController.updateOrderTrackingDetails);
adminRouter.patch("/orders/:id/booking-details", AdminController.updateOrderTrackingDetails);
adminRouter.put("/orders/:id/booking-details", AdminController.updateOrderTrackingDetails);
