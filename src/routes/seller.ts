...
sellerRouter.put('/profile', profileCtrl.updateProfile);
sellerRouter.patch('/profile', profileCtrl.updateProfile);
sellerRouter.get('/me', profileCtrl.getProfile);
sellerRouter.put('/me', profileCtrl.updateProfile);
sellerRouter.patch('/me', profileCtrl.updateProfile);
