...
async function seedProducts() {
  ...
  try {
    ...
    if (!sellerRole) {
      throw new Error(
        "Seller role not found. Please run seedRoles.ts and seedUsers.ts first."
      );
    }
    ...
    if (!menCategory || !womenCategory) {
      throw new Error(
        "Required category structure missing. Run seedCategory.ts first."
      );
    }
    ...
    if (!menClothing || !womenClothing) {
      throw new Error(
        "Clothing categories not found. Run seedCategory.ts first."
      );
    }
    ...
    const dummyProducts = [
      {
        name: "Blue Shirt",
        description:
          "Premium cotton shirt perfect for casual and semi-formal occasions. Comfortable fit with modern design.",
        brand: "Levis",
        images: [
      ...
      },
      {
        name: "Red Dress",
        description:
          "Elegant party dress with a flattering silhouette. Perfect for evening events and special occasions.",
        brand: "Only",
        images: [
          "https://jiffy-products.s3.ap-south-1.amazonaws.com/Screenshot+2025-10-04+133125.png",
          "https://jiffy-products.s3.ap-south-1.amazonaws.com/Screenshot+2025-10-04+144159.png",
      ...
      },
      {
        name: "Classic Jeans",
        description:
          "Durable denim jeans with a classic fit. Perfect for everyday wear.",
        brand: "Levis",
        images: [
          "https://jiffy-products.s3.ap-south-1.amazonaws.com/Screenshot+2025-10-04+133125.png",
        ],
    ...
    await t.commit();
    console.log(
      `✅ Successfully seeded ${dummyProducts.length} products with variants.`
    );
  } catch (error) {
    await t.rollback();
