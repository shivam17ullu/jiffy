 ...
 */
export async function assertSellerCanAccess(userId: number): Promise<void> {
...
export async function assertSellerCanAccessByPhone(
  phone_number: string
): Promise<void> {
